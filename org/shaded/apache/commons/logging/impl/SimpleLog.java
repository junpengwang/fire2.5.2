...
/*     */     
/*     */ 
/* 173 */     showLogName = getBooleanProperty("org.shaded.apache.commons.logging.simplelog.showlogname", showLogName);
/* 174 */     showShortName = getBooleanProperty("org.shaded.apache.commons.logging.simplelog.showShortLogname", showShortName);
/* 175 */     showDateTime = getBooleanProperty("org.shaded.apache.commons.logging.simplelog.showdatetime", showDateTime);
/*     */     
/* 177 */     if (showDateTime) {
/* 178 */       dateTimeFormat = getStringProperty("org.shaded.apache.commons.logging.simplelog.dateTimeFormat", dateTimeFormat);
/*     */       try
/*     */       {
...
/*     */     
/*     */ 
/* 217 */     String lvl = getStringProperty("org.shaded.apache.commons.logging.simplelog.log." + this.logName);
/* 218 */     int i = String.valueOf(name).lastIndexOf(".");
/* 219 */     while ((null == lvl) && (i > -1)) {
/* 220 */       name = name.substring(0, i);
/* 221 */       lvl = getStringProperty("org.shaded.apache.commons.logging.simplelog.log." + name);
/* 222 */       i = String.valueOf(name).lastIndexOf(".");
/*     */     }
/*     */     
/* 225 */     if (null == lvl) {
/* 226 */       lvl = getStringProperty("org.shaded.apache.commons.logging.simplelog.defaultlog");
/*     */     }
/*     */     
...
/* Location:              /Users/junpengwang/Downloads/Download/firebase-client-android-2.5.2.jar!/org/shaded/apache/commons/logging/impl/SimpleLog.class
