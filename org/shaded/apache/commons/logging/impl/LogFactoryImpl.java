...
/*   84 */   private static final int PKG_LEN = "org.shaded.apache.commons.logging.impl.".length();
/*      */   
...
/*      */ 
/*      */ 
/*  176 */   private static final String[] classesToDiscover = { "org.shaded.apache.commons.logging.impl.Log4JLogger", "org.shaded.apache.commons.logging.impl.Jdk14Logger", "org.shaded.apache.commons.logging.impl.Jdk13LumberjackLogger", "org.shaded.apache.commons.logging.impl.SimpleLog" };
/*      */   
/*      */ 
/*      */ 
/*      */ 
...
/*      */   {
/*  555 */     return isLogLibraryAvailable("Jdk13Lumberjack", "org.shaded.apache.commons.logging.impl.Jdk13LumberjackLogger");
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  571 */     return isLogLibraryAvailable("Jdk14", "org.shaded.apache.commons.logging.impl.Jdk14Logger");
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  584 */     return isLogLibraryAvailable("Log4J", "org.shaded.apache.commons.logging.impl.Log4JLogger");
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*      */   {
/*  823 */     this.allowFlawedContext = getBooleanConfiguration("org.shaded.apache.commons.logging.Log.allowFlawedContext", true);
/*  824 */     this.allowFlawedDiscovery = getBooleanConfiguration("org.shaded.apache.commons.logging.Log.allowFlawedDiscovery", true);
/*  825 */     this.allowFlawedHierarchy = getBooleanConfiguration("org.shaded.apache.commons.logging.Log.allowFlawedHierarchy", true);
/*      */   }
/*      */   
/*      */ 
/*      */ 
...
/*  869 */           informUponSimilarName(messageBuffer, specifiedLogClassName, "org.shaded.apache.commons.logging.impl.Log4JLogger");
/*  870 */           informUponSimilarName(messageBuffer, specifiedLogClassName, "org.shaded.apache.commons.logging.impl.Jdk14Logger");
/*  871 */           informUponSimilarName(messageBuffer, specifiedLogClassName, "org.shaded.apache.commons.logging.impl.Jdk13LumberjackLogger");
/*  872 */           informUponSimilarName(messageBuffer, specifiedLogClassName, "org.shaded.apache.commons.logging.impl.SimpleLog");
/*      */         }
...
/*      */     }
/*  964 */     String specifiedClass = (String)getAttribute("org.shaded.apache.commons.logging.Log");
/*      */     
...
/*      */       }
/*      */       
/*  971 */       specifiedClass = (String)getAttribute("org.shaded.apache.commons.logging.log");
/*      */     }
/*      */     
...
/*      */       try
/*      */       {
/*  980 */         specifiedClass = getSystemProperty("org.shaded.apache.commons.logging.Log", null);
/*      */       } catch (SecurityException e) {
...
/*      */       try
/*      */       {
/*  995 */         specifiedClass = getSystemProperty("org.shaded.apache.commons.logging.log", null);
/*      */       } catch (SecurityException e) {
...
/* Location:              /Users/junpengwang/Downloads/Download/firebase-client-android-2.5.2.jar!/org/shaded/apache/commons/logging/impl/LogFactoryImpl.class
