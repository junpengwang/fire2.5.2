...
/*     */     try
/*     */     {
/*  80 */       if (null != Class.forName("org.shaded.apache.log4j.Logger")) {
...
/*     */     try
/*     */     {
/*  91 */       if ((null != Class.forName("java.util.logging.Logger")) && (null != Class.forName("org.shaded.apache.commons.logging.impl.Jdk14Logger")))
/*     */       {
...
/*     */     try {
/* 104 */       name = System.getProperty("org.shaded.apache.commons.logging.log");
/* 105 */       if (name == null) {
/* 106 */         name = System.getProperty("org.shaded.apache.commons.logging.Log");
/*     */       }
/*     */     }
/*     */     catch (Throwable t) {}
/* 110 */     if (name != null) {
...
/*     */       } catch (Throwable t) {
/*     */         try {
/* 115 */           setLogImplementation("org.shaded.apache.commons.logging.impl.NoOpLog");
/*     */ 
/*     */         }
/*     */         catch (Throwable u) {}
/*     */       }
...
/* 124 */           setLogImplementation("org.shaded.apache.commons.logging.impl.Log4JLogger");
/*     */         }
/* 126 */         else if (jdk14IsAvailable) {
/* 127 */           setLogImplementation("org.shaded.apache.commons.logging.impl.Jdk14Logger");
/*     */         }
/*     */         else {
/* 130 */           setLogImplementation("org.shaded.apache.commons.logging.impl.NoOpLog");
/*     */         }
/*     */       }
/*     */       catch (Throwable t) {
/*     */         try {
/* 135 */           setLogImplementation("org.shaded.apache.commons.logging.impl.NoOpLog");
/*     */         }
/*     */         catch (Throwable u) {}
/*     */       }
/*     */     }
...
/* Location:              /Users/junpengwang/Downloads/Download/firebase-client-android-2.5.2.jar!/org/shaded/apache/commons/logging/LogSource.class
