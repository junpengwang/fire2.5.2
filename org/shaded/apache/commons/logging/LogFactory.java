...
/*      */     try {
/*  346 */       storeImplementationClass = getSystemProperty("org.shaded.apache.commons.logging.LogFactory.HashtableImpl", null);
/*      */     }
...
/*  354 */       storeImplementationClass = "org.shaded.apache.commons.logging.impl.WeakHashtable";
/*      */     }
/*      */     try {
...
/*      */     catch (Throwable t)
/*      */     {
/*  362 */       if (!"org.shaded.apache.commons.logging.impl.WeakHashtable".equals(storeImplementationClass))
/*      */       {
...
/*      */     try
/*      */     {
/*  489 */       String factoryClass = getSystemProperty("org.shaded.apache.commons.logging.LogFactory", null);
/*  490 */       if (factoryClass != null) {
/*  491 */         if (isDiagnosticsEnabled()) {
/*  492 */           logDiagnostic("[LOOKUP] Creating an instance of LogFactory class '" + factoryClass + "' as specified by system property " + "org.shaded.apache.commons.logging.LogFactory");
/*      */         }
/*      */         
/*      */ 
/*      */ 
...
/*      */ 
/*      */ 
/*  605 */         String factoryClass = props.getProperty("org.shaded.apache.commons.logging.LogFactory");
...
/*      */ 
/*      */ 
/*  650 */       factory = newFactory("org.shaded.apache.commons.logging.impl.LogFactoryImpl", thisClassLoader, contextClassLoader);
/*      */     }
/*      */     
/*  653 */     if (factory != null)
/*      */     {
...
/* 1301 */           Class factoryFromCustomLoader = Class.forName("org.shaded.apache.commons.logging.LogFactory", false, logFactoryClassLoader);
/*      */           
...
/*      */     try
/*      */     {
/* 1575 */       String dest = getSystemProperty("org.shaded.apache.commons.logging.diagnostics.dest", null);
/* 1576 */       if (dest == null) {
/*      */         return;
/*      */       }
/*      */     }
...
/* Location:              /Users/junpengwang/Downloads/Download/firebase-client-android-2.5.2.jar!/org/shaded/apache/commons/logging/LogFactory.class
